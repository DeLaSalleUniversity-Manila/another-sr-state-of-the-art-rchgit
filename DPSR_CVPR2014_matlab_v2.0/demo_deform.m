...
para.iternum = 10;
para.rootpath = './';
para.datapath = 'C:\MATLAB_work\SotA_DATA\Training\';
...
%%%%%%%%%%%%%%%%%Testing%%%%%%%%%%%%%%%%%%%%%%
space_unicorn = glob('C:\MATLAB_work\SotA_DATA\Testing\LR', {'*.png'});
for i = 1:numel(space_unicorn)
    para.inputimagename = space_unicorn{i};
